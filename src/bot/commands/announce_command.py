...
async def announce(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        for group in groups:
            try:
                chat = await context.application.bot.get_chat(group.telegram_id)
                ...
                await context.bot.send_message(group.telegram_id, message)
                logger.info(f"[MESSAGE] Message sent to group: {group.telegram_id}")
